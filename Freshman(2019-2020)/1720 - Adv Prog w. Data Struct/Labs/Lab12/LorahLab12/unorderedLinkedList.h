...
//Date: 4/16/20
//Professor: Dr. Titus
//Program: unorderedLinkedList.h
//File Path: /home/students/jlorah/csc1720/Labs/Lab12/LorahLab12/unorderedLinkedList.h
//Description: Unordered Linked List Header File.
...
public:
    ...
    void deleteSmallest();
      //Function to deletes the smallest item from a list.
...
void orderedLinkedList<Type>::deleteSmallest()
{
        ...
        while(current != NULL) //while current is equal to something/not empty.
        {
