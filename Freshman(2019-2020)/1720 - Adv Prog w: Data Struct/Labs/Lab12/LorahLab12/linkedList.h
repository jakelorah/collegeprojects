...
//File Path: /home/students/jlorah/csc1720/Labs/Lab12/LorahLab12/linkedList.h
...
public:
    ...
    virtual void deleteNode(const Type& deleteItem) = 0;
      ...
      //Virtual Void:
      virtual void deleteSmallest() = 0; //deletes smallest value from list.
    ...
    //reversePrint:
    // void reversePrint(nodeType<type> *current) const; //prints the list reversed.
...
void LinkedListType<Type>::deleteSmallest()
{
        ...
        while(current != NULL) //while current has something in it/not empty.
        {
        ...
        deleteNode(lowest -> info); //deleteNode.
}
