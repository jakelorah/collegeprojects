...
//Date: 3/31/20
//Professor: Dr. Titus
//Program: arrayListType.h
//File Path: /home/students/jlorah/csc1720/Labs/Lab9/LorahLab9/arrayListType.h
//Description: Array List Type Header File.
...
public:
    ...
    virtual void insertFirst(int insertItem) = 0;
      //Function to insert insertItem an item at the beginning of the function.
      //Note that this is an abstract function.
      //Postcondition: calls the insertAt method at index 0.
    ...
    virtual void remove(int removeItem) = 0;
     ...
     virtual void removeAll(int removeItem) = 0;
      //Function to remove all occurances of removeItem from the list.
      //Note that this is an abstract function.
      //Postcondition: If the removeItem is found in the list, 
      //               it is removed from the list and a for loop checks the rest of the list.
      //               If it is not in the list, a message is outputted.
